module github.com/hashicorp/nomad-v1.3.0-beta.1

go 1.17

require github.com/hashicorp/nomad v1.3.0-beta.1
...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20220401211553-29eff9ab2a92 // indirect
